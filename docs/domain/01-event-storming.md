# Event Storming: Realtime Line/Area Chart
...
- multiple series
- realtime append
- Chart.js-like config shape
- columnar typed-array hot path
- automatic downsampling
- requestAnimationFrame render scheduling
- hover tooltip
- legend display and series visibility toggle

제외:

- Chart.js drop-in compatibility
- bar, pie, radar, full scatter, mixed charts
- zoom, pan, brush, cross-chart sync
- public plugin compatibility
- public diagnostics subscription API
